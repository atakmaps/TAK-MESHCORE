...
public class MeshCorePacket {
    ...
    public MeshCorePacket(byte type, byte[] payload) {
        this.type = type;
    ...
    /**
     * Decode an MeshCorePacket from raw bytes.
     */
    public static MeshCorePacket decode(byte[] data) {
        ...
        return new MeshCorePacket(type, payload);
    }
     ...
     */
    public static MeshCorePacket createGpsPacket(String callsign, String fullCallsign,
        ...
        return new MeshCorePacket(TYPE_GPS, out);
    }
     ...
     */
    public static MeshCorePacket createChatPacket(String sender,
                                                    String chatroom,
                                                    String message) {
    ...
    public static MeshCorePacket createChatPacket(String sender,
        ...
        return new MeshCorePacket(TYPE_CHAT, buf.array());
    }
     ...
     */
    public static MeshCorePacket createChatAckPacket(int wireMessageId, byte ackKind) {
        ByteBuffer buf = ByteBuffer.allocate(5);
        buf.order(ByteOrder.BIG_ENDIAN);
        buf.putInt(wireMessageId);
        buf.put(ackKind);
        return new MeshCorePacket(TYPE_ACK, buf.array());
    }
