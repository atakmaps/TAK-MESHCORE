package com.atakmaps.meshcore.plugin.radio;
 ...
 */
public class MeshCoreRadioControlManager implements BtConnectionManager.RawDataListener {

    private static final String TAG = "MeshCore.RadioCtrl";
    ...
    public MeshCoreRadioControlManager(BtConnectionManager btManager) {
